...
<<<<<<< HEAD
        ...
        private void showGetPictureView() {
                ...
                new AlertDialog.Builder(NewProductActivity.this).setItems(lunch, new DialogInterface.OnClickListener() {
                        @Override
        ...
        private void saveResizeImage(Bitmap photo, int name) {
                ...
                // photo =
                // getResizedBitmap(photo,photo.getWidth(),photo.getHeight());
...
>>>>>>> 70da0ea246450abfdb1e61b22e2f1989edd3db4b
